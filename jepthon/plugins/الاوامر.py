...
from ..sql_helper.globals import gvarstatus ؤر	ضذ
...
async def _(event):
	if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
		await event.edit(0
		"** قائمة اوامر الادمن لسورس انتيثون **:\n •═════•| 𝐀𝐧𝐭𝐢 |•═════•\n ⌯︙اختر احدى هذه القوائم\n\n- ( `.اوامر الحظر` )\n- ( `.اوامر الكتم` )\n- ( `.اوامر التثبيت` )\n- ( `.اوامر الاشراف` )\n•═════•| 𝐀𝐧𝐭𝐢 |•═════•\n⌔︙CH 00: @lDDDDV"
)
...
async def _(event):
	if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
		await event.edit(
		"** قائمة اوامر المجـموعه لسورس انتيثون **:\n •═════•| 𝐀𝐧𝐭𝐢 |•═════•\n ⌯︙اختر احدى هذه القوائم\n\n- ( `.اوامر التفليش` )\n- ( `.اوامر المحذوفين` )\n- ( `.اوامر الكروب` )\n•═════•| 𝐀𝐧𝐭𝐢 |•═════•\n⌔︙CH : @lDDDDV"
)
