...
- مثال: .انشاء حساب الرافدين او انتيثون الاسلامي
1- .استثمار (مبلغ) 
- مثال : استثمار 18276
2- .حظ (المبلغ)
- مثال : حظ 17267
...
async def bankar(message):
    ...
    if input == "انتيثون الاسلامي":
        bankn = "مصرف انتيثون الاسلامي"
    elif input == "الرافدين":
    	bankn = "مصرف الرافدين"
    elif input != "الرافدين" or "انتيثون الاسلامي":
