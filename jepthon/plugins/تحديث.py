...
async def print_changelogs(event, ac_br, changelog):
    changelog_str = (
        f"**⌯︙قام مطورين السورس بتحديث انتيثون**\n⌯︙**التـغييرات\n** {changelog}"
    )
...
async def upstream(event):
    ...
    if changelog == "" and not force_update:
        await event.edit(
            "**⌯︙سورس انتيثون محدث الى اخر اصدار **\n"
            f"**قـنـاة سـورس انتيثون** : @lDDDDV"
        )
        return repo.__del__()
    if conf == "" and not force_update:
        ...
        return await event.respond(
            f"⌔ :  لتحديث سورس انتيثون ارسل : `.تحديث الان` "
        )
    ...
    if conf == "الان":
        await event.edit("** ⌯︙جار تحـديـث سـورس انتيثون انـتـظـر قـليـلا 🔨**")
